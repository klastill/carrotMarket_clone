...
const Community: NextPage = () => {
  return (
    <div>
      <span className="inline-flex my-3 ml-4 items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
        동네질문
      </span>
      ...
      <div>
        ...
        <div className="flex px-4 space-x-5 mt-3 text-gray-700 py-2 border-b  w-full">
      ...
      <div className="px-4 my-4 space-y-4">
        <div className="flex items-start space-x-3">
          <div className="w-8 aspect-square bg-slate-200 rounded-full" />
          <div>
            <span className="text-base block font-medium text-gray-700">
              Steve Jebs
            </span>
